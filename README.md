...
If you are just looking to install the theme or the plugin, checkout my other repositories: [waldjugend-theme](https://github.com/lwijshoff/waldjugend-theme) and [waldjugend-plugin](https://github.com/lwijshoff/waldjugend-plugin).
